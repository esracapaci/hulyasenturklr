        ...
        <nav class="navbar navbar-default ">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="katalog.php">Ürün Kataloğu<span class="sr-only">(current)</span></a></li>
                    <li class="dropdown">
    ...
    <div class="container">
        ...
        <div class="col-md-9  main_right">
            <div class="col-md-12 main_cont">
                <h2>Ürün Kataloğu</h2>
                <div class="col-md-6">
                    <h2>Collection 1 <span style="color:#8ca084">|</span>2018</h2>
                    <div class="col-md-6">
                        <a href="http://www.emagcloud.com/lr/TR_Collection012018_2655/index.html#/1/" target="_blank">
                            <div class="row" align="center" >
                                <img src="Assets\imaj\TR_Collection012018-_e7a3002350.jpg" class="img-responsive-katalog">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <div class="katalog_icerik">
                            <p>Collection kataloğumuzda şu anda satın alabileceğiniz ürünleri bulabilirsiniz. Ana kataloğumuz özellikle yeni ürünlerin önemli içerikleri ve etkileri hakkında bilgiler içermektedir.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <h2>LR World 01</h2>
                    <div class="col-md-6">
                        <a href="http://www.emagcloud.com/lr/TR_LRW012018_o.LT_6984/index.html" target="_blank">
                            <div class="row" align="center" >
                                <img src="Assets\imaj\TR_LRW012018_o_1df4edbbff.jpg" class="img-responsive-katalog">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <div class="katalog_icerik">
                            <p>LR World aylık kataloğumuz her ay değişik indirimler ile yayınlanmaktadır.</p>
                        </div>
                    </div>
                </div>
            </div>
